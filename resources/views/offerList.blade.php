...
<ul id="myTab" class="nav nav-tabs" role="tablist">
  <li class="nav-item">
    <a href="#offers" id="offers-tab" class="nav-link active" role="tab" data-toggle="tab" aria-controls="offers" aria-selected="true">依頼中</a>
  </li>
  <li class="nav-item">
...
<div id="myTabContent" class="tab-content mt-3">
    ...
    <div id="offers" class="tab-pane active" role="tabpanel" aria-labelledby="offers-tab">
      　<div class="card">
          <div class="card-header">あなたが依頼しているジョブです</div>
  ...
  <div id="oders" class="tab-pane" role="tabpanel" aria-labelledby="oders-tab">
      <div class="card">
          <div class="card-header">配達員が承認してたオファーです</div>
          <table class="table mb-0">
            <tr>
                <td>日付</td>
                <td>サービスタイプ</td>
  ...
  <div id="delivery" class="tab-pane" role="tabpanel" aria-labelledby="delivery-tab">
      <div class="card">
          <div class="card-header">現在、配達員が配達中のオファーです。</div>
          <table class="table mb-0">
            <tr>
                <td>日付</td>
                <td>サービスタイプ</td>
  ...
  <div id="slip" class="tab-pane" role="tabpanel" aria-labelledby="slip-tab">
      <div class="card">
          <div class="card-header">受取人が不在のオファーです。配達員が商品を持っています。</div>
          <table class="table mb-0">
            <tr>
                <td>日付</td>
                <td>サービスタイプ</td>
